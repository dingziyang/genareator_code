...
import com.vcg.code.dao.BaseDao;
import com.vcg.code.dao.BaseExample;
import com.vcg.code.dao.BaseModel;
import com.vcg.code.dao.BaseService;
import com.vcg.code.dao.BaseServiceImpl;
...
/*	private static String url = "jdbc:mysql://192.168.3.160:3306/vcg";
	private static String username = "dev_provider";
	private static String password = "dev@pvd123";*/
	
/*	private static String url = "jdbc:mysql://rm-rj9atjx67si0y88o7o.mysql.rds.aliyuncs.com/vcg";
	private static String username = "getty";
	private static String password = "getty@#1";*/
	
/*	private static String url = "jdbc:mysql://rm-2ze94l5qkx3920xglo.mysql.rds.aliyuncs.com:3306/test1";
...
//	private static String url = "jdbc:mysql://192.168.0.241:3306/pmpmain";
//	private static String username = "sdcm";
//	private static String password = "Sdcm_123456";
//	
//	private static String driverClass = "com.mysql.jdbc.Driver";
	
	private static String url = "jdbc:oracle:thin:@192.168.0.200:1522:sdcm";
	private static String username = "sdcm";
	private static String password = "Sdcm123456";
	...
	public static void main(String[] args) throws Exception {
		...
		List lst=null;
		//lst=Arrays.asList("istock_resource");
		lst=Arrays.asList(new String []{"A_USER"});
		//lst=Arrays.asList("getty_editor_collection");
		//lst=new ArrayList();
		FileInputStream in = generatorSqlmap.genneratorBoot(url, username, password, driverClass, "outstorage2", "com.vcg.edit",
				lst,isGenerator);
/*		FileInputStream in = generatorSqlmap.genneratorCloud(url, username, password, driverClass, "standardstorage", "com.vcg.instock2",
				lst,isGenerator);*/
		delAllFile("e:/output/");
	...
	public FileInputStream genneratorCloud(String url, String username, String password, String driverClass,
		...
		String mainRun = "/" + Thread.currentThread().getContextClassLoader().getResource("template/cloud/Main.vm")
				.toString().substring(6);
		FileUtils.copyFile(new File(mainRun), new File(serviceImplPath + "/com/vcg/instorage/Main.java"));
